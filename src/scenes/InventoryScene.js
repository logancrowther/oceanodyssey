...
export const CATCH_DRAWERS = {
  ...
  fangtooth: (g, x, y, weightKg) => drawFangtooth(g, x, y, 0.6 * sizeScaleFor('fangtooth', weightKg)),
  black_dragonfish: (g, x, y, weightKg) => drawBlackDragonfish(g, x, y, 0.5 * sizeScaleFor('black_dragonfish', weightKg)),
  viperfish: (g, x, y, weightKg) => drawViperfish(g, x, y, 0.54 * sizeScaleFor('viperfish', weightKg)),
  pacific_blackdragon: (g, x, y, weightKg) => drawPacificBlackdragon(g, x, y, 0.58 * sizeScaleFor('pacific_blackdragon', weightKg)),
  loosejaw: (g, x, y, weightKg) => drawLoosejaw(g, x, y, 0.5 * sizeScaleFor('loosejaw', weightKg)),
  stoplight_loosejaw: (g, x, y, weightKg) => drawStoplightLoosejaw(g, x, y, 0.5 * sizeScaleFor('stoplight_loosejaw', weightKg)),
  // A much smaller multiplier than every other icon here - the real
  // animal's own extremely long ribbon body would otherwise overflow a
  // small inventory cell at the same scale everything else uses.
  giant_oarfish: (g, x, y, weightKg) => drawGiantOarfish(g, x, y, 0.24 * sizeScaleFor('giant_oarfish', weightKg)),
  giant_grenadier: (g, x, y, weightKg) => drawGiantGrenadier(g, x, y, 0.46 * sizeScaleFor('giant_grenadier', weightKg)),
  roundnose_grenadier: (g, x, y, weightKg) => drawRoundnoseGrenadier(g, x, y, 0.5 * sizeScaleFor('roundnose_grenadier', weightKg)),
  coryphaenoid_grenadier: (g, x, y, weightKg) =>
    drawCoryphaenoidGrenadier(g, x, y, 0.5 * sizeScaleFor('coryphaenoid_grenadier', weightKg)),
  abyssal_grenadier: (g, x, y, weightKg) => drawAbyssalGrenadier(g, x, y, 0.5 * sizeScaleFor('abyssal_grenadier', weightKg)),
  tripod_fish: (g, x, y, weightKg) => drawTripodFish(g, x, y, 0.5 * sizeScaleFor('tripod_fish', weightKg)),
  telescopefish: (g, x, y, weightKg) => drawTelescopefish(g, x, y, 0.5 * sizeScaleFor('telescopefish', weightKg)),
  barreleye_fish: (g, x, y, weightKg) => drawBarreleyeFish(g, x, y, 0.5 * sizeScaleFor('barreleye_fish', weightKg)),
  deep_sea_hatchetfish: (g, x, y, weightKg) =>
    drawDeepSeaHatchetfish(g, x, y, 0.45 * sizeScaleFor('deep_sea_hatchetfish', weightKg)),
  giant_hatchetfish: (g, x, y, weightKg) => drawGiantHatchetfish(g, x, y, 0.5 * sizeScaleFor('giant_hatchetfish', weightKg)),
  bigeye_fish: (g, x, y, weightKg) => drawBigeyeFish(g, x, y, 0.54 * sizeScaleFor('bigeye_fish', weightKg)),
  deep_sea_smelt: (g, x, y, weightKg) => drawDeepSeaSmelt(g, x, y, 0.48 * sizeScaleFor('deep_sea_smelt', weightKg)),
  bristlemouth: (g, x, y, weightKg) => drawBristlemouth(g, x, y, 0.42 * sizeScaleFor('bristlemouth', weightKg)),
  ...
  spinosaurus: (g, x, y, weightKg) => drawSpinosaurus(g, x, y, 0.22 * sizeScaleFor('spinosaurus', weightKg)),
