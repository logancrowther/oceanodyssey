...
//
// Plastic Lure and Abyssal Bait are never sold directly here (see
// `crateOnly` and ShopScene's Buy list, which filters them out) - the only
// way to get either is a Bait Crate roll. Both are universal bait (see
...
// pulling one from a crate instead of just buying more Prawns.
export const BAIT = [
